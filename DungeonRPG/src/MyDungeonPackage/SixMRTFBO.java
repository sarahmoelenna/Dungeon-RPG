...
public class SixMRTFBO {
    ...
    public int fb_texture_6;
	
	public SixMRTFBO(int HEIGHT, int WIDTH){
        ...
        //create texture to render to
          ...
          GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR);
          GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA16, WIDTH, HEIGHT, 0, GL11.GL_RGBA, GL11.GL_FLOAT, (java.nio.ByteBuffer)null);
        ...
        //create texture to render to
          fb_texture_6 = GL11.glGenTextures();
          GL11.glBindTexture(GL11.GL_TEXTURE_2D, fb_texture_6);
          GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR);
          GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA8, WIDTH, HEIGHT, 0, GL11.GL_RGBA, GL11.GL_FLOAT, (java.nio.ByteBuffer)null);
          
          //attach texture to the fbo
          glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL30.GL_COLOR_ATTACHMENT5 , GL11.GL_TEXTURE_2D, fb_texture_6, 0); //ANOTHER OF THIS FOR MRT
          ...
          IntBuffer buffers = BufferUtils.createIntBuffer(6);
